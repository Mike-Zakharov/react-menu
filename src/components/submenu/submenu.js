...
export const submenuData = [
    ...
    {itemId: 'managed-it',
     header: 'Managed IT',
     itemsContent:['Optimal solution','Installation and configuration','Monitoring',
     'Scheduled maintenance','Technical support','Troubleshooting','Modernization'],
    },
    {itemId: 'telecom-solutions',
     header: 'Telecom Solutions',
     itemsContent:['Unified communications','Multimedia','SDN','DCI'],
    },
    {itemId: 'about-us',
     header: 'About Us',
